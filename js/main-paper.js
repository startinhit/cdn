...
window.addEventListener('load', function() {
    $(document).ready(function() {
        ...
        var Shortcode = function(e, t) {
            e && (this.el = e, this.tags = t, this.matches = [], this.regex = "\\[{name}(\\s[\\s\\S]*?)?\\](?:((?!\\s*?(?:\\[{name}|\\[\\/(?!{name})))[\\s\\S]*?)(\\[/{name}\\]))?", this.el.jquery && (this.el = this.el[0]), this.matchTags(), this.convertMatchesToNodes(), this.replaceNodes())
        };
        if (Shortcode.prototype.matchTags = function() {
                var e, t, a, r, n, s, o, i = this.el.outerHTML;
                for (var c in this.tags) {
                    if (!this.tags.hasOwnProperty(c)) return;
                    a = this.template(this.regex, {
                        name: c
                    });
                    for (var h = 0, p = (e = i.match(new RegExp(a, "g")) || []).length; h < p; h++) r = (t = e[h].match(new RegExp(a)))[3] ? "" : void 0, s = t[0], n = this.escapeTagRegExp(s), o = this.parseOptions(t[1]), t[2] && (r = t[2].trim(), s = s.replace(r, "").replace(/\n\s*/g, ""), n = this.escapeTagRegExp(s).replace("\\]\\[", "\\]([\\s\\S]*?)\\[")), this.matches.push({
                        name: c,
                        tag: s,
                        regex: n,
                        options: o,
                ...
                var e, t, a = this.el.innerHTML;
                t = function(e, t, a, r, n, s, o) {
                    if (t) return e;
                    var i = document.createElement("span");
                    return i.setAttribute("data-sc-tag", this.tag), i.className = "templateify-sc-node templateify-sc-node-" + this.name, i.outerHTML
                };
                for (var r = 0, n = this.matches.length; r < n; r++) '((data-sc-tag=")|(<pre.*)|(<code.*))?', e = new RegExp('((data-sc-tag=")|(<pre.*)|(<code.*))?' + this.matches[r].regex, "g"), a = a.replace(e, t.bind(this.matches[r]));
                this.el.innerHTML = a
            }, Shortcode.prototype.replaceNodes = function() {
                var e, t, a, r, n, s = this;
                this.el.querySelectorAll(".templateify-sc-node");
                n = function(e) {
                    e.jquery && (e = e[0]), e = s.parseCallbackResult(e), r.parentNode.replaceChild(e, r)
                };
                for (var o = 0, i = this.matches.length; o < i; o++) e = this.matches[o], (r = this.el.querySelector(".templateify-sc-node-" + e.name)) && r.dataset.scTag === e.tag && void 0 !== (t = this.tags[e.name].bind(e)(a = n.bind(e))) && a(t)
                ...
                switch (typeof e) {
                    case "function":
                        ...
                        break;
                    case "string":
                        if (t = document.createElement("div"), a = document.createDocumentFragment(), t.innerHTML = e, (r = t.childNodes).length) {
                            for (var n = 0, s = r.length; n < s; n++) a.appendChild(r[n].cloneNode(!0));
                            e = a
                        } else e = document.createTextNode(e);
                        break;
                    case "object":
                        e.nodeType || (e = JSON.stringify(e), e = document.createTextNode(e))
                }
                return e
            ...
            $.fn[pluginName] = function(e) {
                return this.each(function() {
                    $.data(this, pluginName) || $.data(this, pluginName, new Shortcode(this, e))
                }), this
            }
        }
        ...
        ! function(e) {
            e.fn.menuify = function() {
                return this.each(function() {
                    for (var t = e(this), n = t.find(".LinkList ul > li").children("a"), a = n.length, r = 0; r < a; r++) {
                        var i = n.eq(r),
                            u = i.text();
                        if ("_" !== u.charAt(0))
                            if ("_" === n.eq(r + 1).text().charAt(0)) {
                                var s = i.parent();
                                s.append('<ul class="sub-menu m-sub"/>')
                            }
                        "_" === u.charAt(0) && (i.text(u.replace("_", "")), i.parent().appendTo(s.children(".sub-menu")))
                    }
                    for (r = 0; r < a; r++) {
                        var c = n.eq(r),
                            l = c.text();
                        if ("_" !== l.charAt(0))
                            if ("_" === n.eq(r + 1).text().charAt(0)) {
                                var p = c.parent();
                                p.append('<ul class="sub-menu2 m-sub"/>')
                            }
                        "_" === l.charAt(0) && (c.text(l.replace("_", "")), c.parent().appendTo(p.children(".sub-menu2")))
                    }
            ...
            ! function(a) {
                a.fn.tabify = function(t) {
                    return t = jQuery.extend({
                        ...
                        var e = a(this),
                            s = e.children("[tab-ify]"),
                            i = "tab-active";
                        if (1 == t.onHover) var n = "mouseenter";
                        else n = "click";
                        e.prepend('<ul class="select-tab"></ul>'), s.each(function() {
                            1 == t.animated && a(this).addClass("tab-animated"), e.find(".select-tab").append('<li><a href="javascript:;">' + a(this).attr("tab-ify") + "</a></li>")
                        }).eq(0).addClass(i).addClass("tab-" + t.transition), e.find(".select-tab a").on(n, function() {
                            var e = a(this).parent().index();
                            return a(this).closest(".select-tab").find(".active").removeClass("active"), a(this).parent().addClass("active"), s.removeClass(i).removeClass("tab-" + t.transition).eq(e).addClass(i).addClass("tab-" + t.transition), !1
        ...
        if (data.view.isSingleItem == 'true') {
            ...
            ! function(t) {
                ...
                t.timeago = function(e) {
                    return e instanceof Date ? r(e) : r("string" == typeof e ? t.timeago.parse(e) : "number" == typeof e ? new Date(e) : t.timeago.datetime(e))
                };
                var e = t.timeago;
                t.extend(t.timeago, {
                    settings: {
                    ...
                    inWords: function(e) {
                        ...
                        var i = this.settings.strings,
                            a = i.prefixAgo,
                            r = i.suffixAgo;
                        if (this.settings.allowFuture && e < 0 && (a = i.prefixFromNow, r = i.suffixFromNow), !this.settings.allowPast && e >= 0) return this.settings.strings.inPast;
                        ...
                        var c = n < 45 && m(i.seconds, Math.round(n)) || n < 90 && m(i.minute, 1) || o < 45 && m(i.minutes, Math.round(o)) || o < 90 && m(i.hour, 1) || s < 24 && m(i.hours, Math.round(s)) || s < 42 && m(i.day, 1) || u < 30 && m(i.days, Math.round(u)) || u < 45 && m(i.month, 1) || u < 365 && m(i.months, Math.round(u / 30)) || l < 1.5 && m(i.year, 1) || m(i.years, Math.round(l)),
                            d = i.wordSeparator || "";
                        return void 0 === i.wordSeparator && (d = " "), t.trim([a, c, r].join(d))
                    },
                    parse: function(e) {
                        var i = t.trim(e);
                ...
                var i = {
                    init: function() {
                        i.dispose.call(this);
                        var r = t.proxy(a, this);
                        r();
                        var n = e.settings;
                        n.refreshMillis > 0 && (this._timeagoInterval = setInterval(r, n.refreshMillis))
                    },
                    update: function(i) {
                        var r = i instanceof Date ? i : e.parse(i);
                        t(this).data("timeago", {
                            datetime: r
                        }), e.settings.localeTitle && t(this).attr("title", r.toLocaleString()), a.apply(this)
                    },
                ...
                function a() {
                    ...
                    return isNaN(a.datetime) || (0 === i.cutoff || Math.abs(n(a.datetime)) < i.cutoff ? t(this).text(r(a.datetime)) : t(this).attr("title").length > 0 && t(this).text(t(this).attr("title"))), this
                }
            ...
            }), $(".date-time a").each(function() {
                var t = $(this),
                    e = (e = (e = t.html()).replace("SA", "AM")).replace("CH", "PM");
                t.attr("datetime", e), t.html(jQuery.timeago(e))
            });
        }
        $(function() {
        ...
        if (data.view.isPost == 'true') {
            ...
            $(function() {
                jQuery.getScript("https://cdn.firebase.com/js/client/2.3.2/firebase.js").done(function() {
                    $.each($(".post-views"), function(t, a) {
                        var e = $(a).find("#postviews"),
                            i = $('link[rel="canonical"]').attr("href"),
                            n = new Firebase("https://nguyen-tinh.firebaseio.com/pages/id/" + $(a).attr("data-id"));
                        n.once("value", function(t) {
                            var r = t.val(),
                                l = !1;
                            null == r && ((r = {}).value = 0, r.url = $(a).attr("data-href"), r.id = $(a).attr("data-id"), l = !0), e.text(r.value), r.value++, "/" != window.location.pathname && $(a).attr("data-href") == i && (l ? n.set(r) : n.child("value").set(r.value))
                        })
                    })
                })
            });
    ...
    function auto() {
        ...
        if (new Date().getHours() > 21 || new Date().getHours() < 6) {
            ...
            localStorage.setItem('227519dark', 'true')
        } else {
            document.body.classList.remove('dark');
            localStorage.setItem('227519dark', 'false')
        }
    }

    function dark() {
        localStorage.getItem('227519dark') == 'true' ? document.body.classList.add('dark') : document.body.classList.remove('dark')
    }
    if (localStorage.getItem('227519auto') == 'true') {
        auto()
    } else {
        localStorage.getItem('227519dark') == null ? auto() : dark()
    }

    function toggle() {
        localStorage.setItem('227519auto', localStorage.getItem('227519auto') == 'true' ? 'false' : 'true');
        localStorage.getItem('227519auto') == 'true' ? auto() : document.body.classList.remove('auto')
    }

    function mode() {
        document.body.classList.remove('auto');
        localStorage.removeItem('227519auto');
        localStorage.setItem('227519dark', localStorage.getItem('227519dark') == 'true' ? 'false' : 'true');
        dark()
    };
})
